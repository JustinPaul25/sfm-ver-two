...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('samplings/{sampling}/timestamps', [SamplingController::class, 'updateTimestamps'])->name('samplings.update-timestamps');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('users/database/download', [UserController::class, 'downloadDatabase'])->name('users.database.download');
